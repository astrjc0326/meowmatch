...
export default function LogIn ({navigation}: any) {
    return (
      ...
      <LOGOSVG />
      <Text style={tw` text- center text-5xl font-bold pt-1 text-titlecolor`}>MeowMatch</Text>
      </View>
      ...
      <View style={tw`items-center flex-2 pt-8`}>
        ...
        <TouchableOpacity style={tw`font-semibold mb-2 px-4`} onPress={() => { navigation.navigate('MobileLogin') }}>
          <Text style={tw`text-gray-500 font-semibold px-4 mb-2 text-titlecolor`}>Use Mobile number</Text>
        </TouchableOpacity>
